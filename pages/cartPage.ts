...
export class CartPage {
  ...
  constructor(page: Page) {
    ...
    this.productQuantity = page.locator('span[class="w-8 text-center font-semibold"]')
    this.increaseProductQtyButton = page.locator('button[data-test-id^="quantity-increase-"]')
    ;((this.removeProductButton = page.locator('button[data-test-id^="remove-"]')),
      // Order Summary
